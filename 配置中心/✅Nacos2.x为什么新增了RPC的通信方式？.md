...
![image.png](./img/OCP6ndBohYkzrbzo/1688463935239-bb06659a-8217-4ec5-ab22-e2001053409a-365813.png)

在Nacos的早期版本中，节点之间的通信采用了HTTP协议。在高并发、大规模集群环境下，由于HTTP的连接管理和请求响应的开销，会导致一些性能和稳定性方面的问题。

![image.png](./img/OCP6ndBohYkzrbzo/1688464018606-9559cfb2-b8b8-4f1a-9cfe-c8a50a204867-739310.png)
...
![image.png](./img/OCP6ndBohYkzrbzo/1688464160204-4ab46daa-eef1-4454-9e65-1f490e888bb5-318008.png)

配置管理之前用Http1.1的Keep Alive模式30s发一个心跳模拟长链接，协议难以理解，内存消耗大，推送性能弱，因此2.0通过gRPC彻底解决这些问题，内存消耗大量降低。

![image.png](./img/OCP6ndBohYkzrbzo/1688464408682-715d06d3-aa7d-474b-91b4-7878ceda245d-920451.png)
